...
Character::Character(int winWidth, int winHeight) : windowWidthg(winWidth), windowHeight(winHeight)
{
...
{
    return Vector2{static_cast<float> (windowWidthg) / 2.0f - scale * (0.5f * width),
